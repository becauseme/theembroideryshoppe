...
class Videogallery_Videogallery_Adminhtml_VideogalleryController extends Mage_Adminhtml_Controller_action
{
        ...
        if(!is_array($videogalleryIds)) {
            ...
            try {
                foreach ($videogalleryIds as $videogalleryId) {
                    $videogallery = Mage::getModel('videogallery/videogallery')->load($videogalleryId);
                    $videogallery->delete();
                }
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($videogalleryIds)) {
            ...
            try {
                foreach ($videogalleryIds as $videogalleryId) {
                    $videogallery = Mage::getSingleton('videogallery/videogallery')
                        ->load($videogalleryId)
                ...
                $this->_getSession()->addSuccess(
                    $this->__('Total of %d record(s) were successfully updated', count($videogalleryIds))
                );
            } catch (Exception $e) {
