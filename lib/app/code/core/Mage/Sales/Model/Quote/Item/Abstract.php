...
abstract class Mage_Sales_Model_Quote_Item_Abstract extends Mage_Core_Model_Abstract
{
	...
	/* Changes on 23/01/2010  */

	public function setCustomeLogo($value)
	{
		 return $this->setData('select_logo', $value);
	}
	/*public function getCustomeLogo()
	{
	
		echo $this->getData('select_logo');
		exit;
		return $this->_getData('select_logo');
	}*/
